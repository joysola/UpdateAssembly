...
namespace TileImageViewer.Controls
{
    ...
    public partial class UCTextBoxEx : UCControlBase
    {
        ...
        /// </summary>
        private int m_intSelectionStart = 0;

        /// <summary>
        /// The m int selection length
        /// </summary>
        private int m_intSelectionLength = 0;
        ...
        private void UCTextBoxEx_SizeChanged(object sender, EventArgs e)
        {
        ...
        /// The m FRM anchor
        /// </summary>
        private Forms.FrmAnchor m_frmAnchor;
        ...
        {
            if (keyBoardType == TileImageViewer.Controls.KeyBoardType.Null)
                return;
            ...
            switch (keyBoardType)
            {
                ...
                case TileImageViewer.Controls.KeyBoardType.UCKeyBorderHand:
        ...
        /// </summary>
        private IntPtr m_HandAppWin;

        /// <summary>
        /// The m hand p win
        /// </summary>
        private Process m_HandPWin = null;

        /// <summary>
        /// The m hand executable name
        /// </summary>
        private string m_HandExeName = System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "HandInput\\handinput.exe");
